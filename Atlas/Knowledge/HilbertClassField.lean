...
field ([Milne 2020, Chap. V, §3, Ex. 3.9, p.159][MilneCFT]; Yamaguchi 2026,
`GlobalClassFieldTheory/GlobalClassFields/SmallHilbertClassField.lean:29`). -/
...
([Milne 2020, Introduction, Ex. 0.6, p.6][MilneCFT]; Yamaguchi 2026,
`GlobalClassFieldTheory/GlobalClassFields/BigHilbertClassField.lean:26`). -/
...
included ([Milne 2020, Chap. V, §3, Ex. 3.9, p.159][MilneCFT]; Yamaguchi 2026,
...
zero modulus's congruence subgroup ([Milne 2020, Introduction, Ex. 0.6, p.6][MilneCFT];
Yamaguchi 2026,
...
Yamaguchi 2026,
`GlobalClassFieldTheory/GlobalClassFields/SmallHilbertClassField.lean:38`). -/
...
([Milne 2020, Chap. V, §3, Thm. 3.17, p.161][MilneCFT]; Yamaguchi 2026,
