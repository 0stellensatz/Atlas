...
([Yamaguchi 2026, `LocalClassFieldTheory/Finite/LocalReciprocity/FiniteResidueFrobenius.lean:49`]
[Yamaguchi2026]). -/
...
Frobenius ([Milne 2020a, Chap. 7, Example 7.54, p.129][MilneANT] — "The Galois
group `Gal(k_n/k)` is a cyclic group of order `n`, having as canonical
generator the Frobenius element `x ↦ x^q`";
...
([Yamaguchi 2026, `LocalClassFieldTheory/Finite/LocalReciprocity/FiniteResidueFrobenius.lean:266`]
[Yamaguchi2026]). -/
