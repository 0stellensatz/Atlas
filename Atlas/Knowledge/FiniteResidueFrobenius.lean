...
positive modulus is carried as a private `NeZero` instance on the degree, and
the transition to a subextension is the layer's
`Atlas.Knowledge.ProfiniteInteger.castHom_comp_reduction` read pointwise.
...
private instance : NeZero (Module.finrank k L) := ⟨Module.finrank_pos.ne'⟩
...
one to the arithmetic Frobenius
([Yamaguchi 2026, `LocalClassFieldTheory/Finite/LocalReciprocity/FiniteResidueFrobenius.lean:50`]
[Yamaguchi2026]). -/
...
Frobenius ([Milne 2020, Chap. I, §1, p.20][MilneCFT] — "`Gal(L/K)` is a cyclic
group, generated by the unique element `σ` such that `σα ≡ α^q`";
[Yamaguchi 2026, `LocalClassFieldTheory/Finite/LocalReciprocity/FiniteResidueFrobenius.lean:104`]
[Yamaguchi2026]). -/
...
([Yamaguchi 2026, `LocalClassFieldTheory/Finite/LocalReciprocity/FiniteResidueFrobenius.lean:127`]
[Yamaguchi2026]). -/
...
([Yamaguchi 2026, `LocalClassFieldTheory/Finite/LocalReciprocity/FiniteResidueFrobenius.lean:267`]
[Yamaguchi2026]). -/
