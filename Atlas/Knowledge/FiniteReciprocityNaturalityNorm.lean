...
restriction from `G(L'|K')` to `G(L|K)` (Yamaguchi 2026,
`MainNaturality.lean:34`). -/
...
representative's class (Yamaguchi 2026,
`MainNaturality.lean:56`). -/
@[simp]
...
first naturality diagram (Yamaguchi 2026, `MainNaturality.lean:74`). -/
...
(Yamaguchi 2026, `MainNaturality.lean:98`). -/
@[simp]
...
cyclic subgroup generated by a Frobenius lift (Yamaguchi 2026,
`MainNaturality.lean:114`). -/
...
residue degree (Yamaguchi 2026, `MainNaturality.lean:136`). -/
...
exponent multiplied by `f_{K'|K}` (Yamaguchi 2026,
`MainNaturality.lean:159`). -/
...
(Yamaguchi 2026, `MainNaturality.lean:185`). -/
@[simp]
...
original exponent** (Yamaguchi 2026,
`MainNaturality.lean:203`). -/
@[simp]
...
original lift along the left vertical map** (Yamaguchi 2026,
`MainNaturality.lean:245`). -/
...
(Yamaguchi 2026, `MainNaturality.lean:274`). -/
...
Frobenius lift is totally ramified** (Yamaguchi 2026,
`MainNaturality.lean:312`). -/
...
(Yamaguchi 2026, `MainNaturality.lean:394`). -/
...
(Yamaguchi 2026, `MainNaturality.lean:413`). -/
...
the base (Yamaguchi 2026, `MainNaturality.lean:467`). -/
@[simp]
...
(Yamaguchi 2026, `MainNaturality.lean:488`). -/
...
(Yamaguchi 2026, `MainNaturality.lean:502`). -/
@[simp]
...
the finite norm quotients (Yamaguchi 2026, `MainNaturality.lean:510`). -/
...
class (Yamaguchi 2026, `MainNaturality.lean:547`). -/
@[simp]
...
taking `S = Σ` and `S' = Σ'` gives the calculation (Yamaguchi 2026,
`MainNaturality.lean:574`). -/
...
the norm `N_{K'|K}` on finite norm quotients (Yamaguchi 2026,
`MainNaturality.lean:631`). -/
...
quotient** (Yamaguchi 2026, `MainNaturality.lean:786`). -/
