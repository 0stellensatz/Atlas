...
`a.2 v` ([Milne 2020, Chap. V, §4, p.169][MilneCFT]; Yamaguchi 2026,
`AlgebraicNumberTheory/Idele/Basic.lean:114`). -/
...
([Milne 2020, Chap. V, §4, p.169][MilneCFT]; Yamaguchi 2026,
`AlgebraicNumberTheory/Idele/Basic.lean:109`). -/
